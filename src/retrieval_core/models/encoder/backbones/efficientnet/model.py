...
class EfficientNet(nn.Module):
    ...
    def __init__(self, blocks_args=None, global_params=None):
        ...
        for block_args in self._blocks_args:
            ...
            # The first block takes care of stride and filter size increase.
    ...
    @classmethod
    def from_name(cls, model_name, override_params=None, output_stride=32):
    ...
    def from_pretrained(cls, model_name, advprop=False, num_classes=1000,
                        in_channels=3, output_stride=32):
        ...
        if in_channels != 3:
            ...
            model._conv_stem = Conv2d(in_channels, out_channels, kernel_size=3,
                                      stride=2, bias=False)
        return model
